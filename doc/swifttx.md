...
This mechanism has been integrated into Bitcore-Node-BASE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BASE-Project/insight-api-base#web-socket-api](https://github.com/BASE-Project/insight-api-base#web-socket-api) 
* API: [https://github.com/BASE-Project/insight-api-base#swifttx-transactions](https://github.com/BASE-Project/insight-api-base#swifttx-transactions) 
...
By default, the BASE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BASE Core daemon:
