...
This issue tracker is only for technical issues related to BASE Core.
General BASE questions and/or support requests and are best directed to the [BASE Discord](https://discord.base.org).
...
### What version of BASE Core are you using?
