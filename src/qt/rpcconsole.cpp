                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBASEPathCustom = GetArg("-zbasebackuppath", "");
    ...
    if(!strzBASEPathCustom.empty()) {
        ui->wallet_customzbasebackuppath->setText(QString::fromStdString(strzBASEPathCustom));
        ui->wallet_customzbasebackuppath_label->setVisible(true);
        ui->wallet_customzbasebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBASEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BASE RPC console.") + "<br>" +
