                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BASE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BASE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and base: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBASE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BASE Core"), this);
    aboutAction->setStatusTip(tr("Show information about BASE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BASE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BASE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BASE addresses"));
    ...
    openAction->setStatusTip(tr("Open a BASE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BASE Core help message to get a list with possible BASE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BASE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BASE network", "", count));
}
...
{
    QString strTitle = tr("BASE Core"); // default title
