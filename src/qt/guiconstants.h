...
/* Base GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BASE"
#define QAPP_ORG_DOMAIN "base.org"
#define QAPP_APP_NAME_DEFAULT "BASE-Qt"
#define QAPP_APP_NAME_TESTNET "BASE-Qt-testnet"
