...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zbaseTracker->HasMintTx(hash))) {
            //zBASE stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZBASE;
...
bool IsZBASEType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZBASE:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZBASE || type == TransactionRecord::MNReward) {
