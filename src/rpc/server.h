...
extern UniValue setzbaseseed(const UniValue& params, bool fHelp);
extern UniValue getzbaseseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbase(const UniValue& params, bool fHelp);
extern UniValue dzbasestate(const UniValue& params, bool fHelp);
