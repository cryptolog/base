...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000006afcf24cd7e2c60a0d0af115f08b15272712aca388bdd82f4bd788b0ebd"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1531068570, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1532131200;        // Saturday, July 21, 2018 12:00:00 AM
        ...
        nBlockZerocoinV2 = 202;                 //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "US warships sail through Taiwan Strait for first time in a year as China tariffs kick in ...";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 250 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("048bfbaf3fcc66693194604bb660b0fedf0ec3b297f7f90b6dd42b0e1bbfffed95ee4859a534fbbdcb871dcbd2b91039e179c59eb89843626ab21b25e1479d4d08") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1531068570;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1743538;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000006afcf24cd7e2c60a0d0af115f08b15272712aca388bdd82f4bd788b0ebd"));
        assert(genesis.hashMerkleRoot == uint256("0x3da2a7b8c38462c18d9d52546da705ac5689810c6cb68beb757bd4884df00b9b"));

        vSeeds.push_back(CDNSSeedData("base.ninja", "dns.base.ninja"));  // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("base.ninja", "dns2.base.ninja")); // Secondary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("base.ninja", "dns3.base.ninja")); // Single node address
        vSeeds.push_back(CDNSSeedData("base.ninja", "dns4.base.ninja")); // Single node address
        vSeeds.push_back(CDNSSeedData("base.ninja", "dns5.base.ninja")); // Single node address
